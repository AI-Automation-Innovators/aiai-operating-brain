...
- Do not invent pricing, timelines, deliverables, or implementation scope.
- Use proof files only when proof actually exists and is clearly documented.
...
- Do not add automation, dependencies, databases, apps, workflows, package files, build systems, or new top-level folders unless explicitly requested.
- Use existing markdown files as source of truth.
